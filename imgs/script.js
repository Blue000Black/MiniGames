...
let colors = [ 
    "url('a3a3a3.png')", 
    "url('scale_1200 (1).jpg')", 
    "url('трубочки.gif')", 
    "url('a3a2281b-9a6a-4110-9d47-71e6d3be5abe.jpeg')", 
    "url('1c5b475ac1c36c3a22adf774276eb52b.png')", 
    "url('jcW6YYWm630xpXicXGPaZ-JvLqMrVGSZdAomh65xBqMhINt3Z0bSlrLvMZVC7dWmq5nc9W_5mwdjPxxJRj11Yjmt.jpg')", 
    "url('36de72992ef185778685cd3b56d0c772.jpg')", 
    "url('746_7zhR6n0xX-U7vZpGv_ZQirS0t3wX_cia8ohaf_x7nbZ6MsWuRnVb1fc-M5waYgHT4WkDS6np4sOKwhKW4TAY.jpg')", 
    "url('Desktop\AS\scale_1200 (2).jpg')", 
    "url('Trulimero_Trulichina.webp')", 
    "", 
    "", 
]; 
...
function updateColors() { 
    for (let i = 0; i < 4; i++) { 
        for (let j = 0; j < 4; j++) { 
            ...
            if (elem.innerText == 0) { 
                elem.parentElement.style.backgroundImage = 
                    colors[0]; 
